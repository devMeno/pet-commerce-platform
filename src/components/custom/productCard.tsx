    ...
    return (
        <div className={'w-full max-w-[185px] md:max-w-[280px] p-[8px] flex flex-col gap-[8px] rounded-[12px] bg-white drop-shadow-md'}>
            ...
            <div className={'flex flex-col md:flex-row gap-2 text-[12px]'}>
                <span className={'text-[#667479]'}>Product : <span className={'font-bold text-[#667479]'}>Food</span></span><span className={'text-[#667479]'}>Size : <span className={'font-bold text-[#667479]'}>385 mg</span></span>
            </div>
            ...
            <div className={'bg-sec-min rounded-[10px] w-full py-[6px] px-[4px] flex justify-center gap-[2px] md:gap-[8px]'}>
                ...
                <span className={'font-bold text-[12px] md:text-[14px] text-[#002A48]'}> Free Toy & Free Shaker</span>
            </div>
        </div>
    );
};
